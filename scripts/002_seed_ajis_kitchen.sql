...
-- Clean old menu items and insert fresh ones
-- WARNING: Run the DELETE first if re-seeding:
-- DELETE FROM menu_items WHERE restaurant_id = '00000000-0000-0000-0000-000000000001';
